...
@section('content')
    ...
    @if (session()->has('readAll'))
        <div class="row">
            <div class="alert alert-success alert-dismissible fade show d-block" role="alert">
                <strong>{{ session()->get('readAll') }}</strong>
    ...
    @if (session()->has('read'))
        <div class="row">
            <div class="alert alert-success alert-dismissible fade show d-block" role="alert">
                <strong>{{ session()->get('read') }}</strong>
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
    ...
    <div class="row row-sm">
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-primary-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class=" mb-3 tx-6 text-white">اجمالي الفواتير</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <h4 class="
                                tx-20 font-weight-bold mb-1 text-white">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-danger-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class=" mb-3 tx-6 text-white">الفواتير الغير مدفوعة</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h3 class=" tx-20 font-weight-bold mb-1
                                text-white">
                                ...
                                <span class="text-white op-7">
                                    ...
                                    @php
                                        ...
                                        if ($count_invoices2 == 0) {
                                            ...
                                            echo ($count_invoices2 / $count_all) * 100 . ' %';
                                        }
                                    @endphp
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-success-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class=" mb-3 tx-6 text-white">الفواتير المدفوعة</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                ...
                                <span class="text-white op-7">
                                    @php
                                        ...
                                        if ($count_invoices1 == 0) {
                                            ...
                                            echo ($count_invoices1 / $count_all) * 100 . ' %';
                                        }
                                    @endphp
                                </span>
                            </span>
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-warning-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class=" mb-3 tx-6 text-white">الفواتير المدفوعة جزئيا</h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                            ...
                            <span class="float-right my-auto mr-auto">
                                ...
                                <span class="text-white op-7">
                                    @php
                                        $count_all = \App\Invoice::count();
                                        $count_invoices1 = \App\Invoice::where('value_status', 3)->count();
