...
@section('content')
    ...
    <div class="row">
        ...
        <!-- Container closed -->
        {{-- add section code --}}
        <div class="modal rounded" id="modaldemo1">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('sections.store') }}" method="post">
                            ...
                            <div class="form-group">
                                <label for="name" class="lead">اسم القسم</label>
                                <input type="text" name="section_name" class="form-control"
                                    placeholder="من فضلك أدخل اسم القسم">
                            </div>
                            <div class="form-group">
                                <label for="description" class="lead">الوصف</label>
                                <input type="text" name="description" class="form-control"
                                    placeholder="من فضلك أدخل وصف القسم">
                            </div>

                            <div class="modal-footer">
                                <button class="btn ripple btn-success" type="submit">إضافة</button>
                                <button class="btn ripple btn-danger" data-dismiss="modal" type="button">إلغاء</button>
                            </div>
                        </form>
