...
<aside class="app-sidebar sidebar-scroll">
    <div class="main-sidebar-header active">
        <a class="desktop-logo logo-light active" href="{{ url('/' . ($page = 'index')) }}">برنامج لإدارة الفواتير</a>
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('الفواتير المدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'paidinvoices')) }}">الفواتير المدفوعه
                                </a>
                            </li>

                        @endcan
                        @can('الفواتير الغير مدفوعة')
                            <li><a class="slide-item" href="{{ url('/' . ($page = 'unpaidinvoices')) }}">الفواتير الغير
                                    مدفوعه</a></li>

                        @endcan
                        @can('الفواتير المدفوعة جزئيا')

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'partiallypaidinvoices')) }}">الفواتير
                                    المدفوعة جزئيا</a></li>
                        @endcan
                        @can('ارشيف الفواتير')

                            <li><a class="slide-item" href="{{ url('/' . ($page = 'ArchivedInvoices')) }}">الأرشيف</a>
                            </li>
                        @endcan
                ...
                <li class="slide">
                    ...
                    <ul class="slide-menu">
                        ...
                        @can('تقرير العملاء')
                            ...
                            <li>
                                <a class="slide-item" href="{{ url('/' . ($page = 'customers_report')) }}">تقارير
                                    العملاء</a>
                            </li>
                        @endcan
                    </ul>
