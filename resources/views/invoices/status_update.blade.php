...
@section('title')
        تغيير الحالة | برنامج الفواتير
@stop
@section('css')
@endsection
@section('title')
    تغيير حالة الدفع | برنامج الفواتير
@stop
@section('page-header')
    <!-- breadcrumb -->
                         ...
                         <div class="row">
                            <div class="col">
                                ...
                                <select name="value_status" class="form-control" id="value_status">
                                    <option value="{{$invoices->value_status}}" selected>{{$invoices->status->name}}</option>
                            ...
                            <div class="col">
                                ...
                                <input type="text" placeholder="YYYY-MM-DD" value="{{$invoices->payment_date}}" class="form-control fc-datepicker"
