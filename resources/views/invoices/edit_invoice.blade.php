                    ...
                    <form action="{{ url('invoices/update') }}" method="post" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="Section" value={{ $invoice->section_id }} class="form-control SlectBox"
                            ...
                            <div class="col">
                                ...
                                <select id="product" name="product" value={{ $invoice->product }} class="form-control">
                                    @if ($invoice->section->id)
                                        <option value="{{ $invoice->product }}">{{ $invoice->product }}</option>
                                    @endif
                                    @foreach ($products->where('section_id', $invoice->section->id) as $product)
                            ...
                            <div class="col">
                                ...
                                <input type="text" value={{ $invoice->Amount_collection }} class="form-control"
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="text" value={{ $invoice->Amount_Commission }}
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <input type="text" class="form-control" value={{ $invoice->Value_VAT }} id="Value_VAT"
                        ...
                        <div class="row">
                            <div class="col">
                                <label for="value_status" class="control-label">حالة الدفع</label>
                                <select name="value_status" class="form-control" id="value_status">
                                    <option value="{{$invoice->value_status}}" selected>{{$invoice->status->name}}</option>
                            ...
                            <div class="col">
                                ...
                                <input type="text" placeholder="YYYY-MM-DD" value="{{$invoice->payment_date}}" class="form-control fc-datepicker"
