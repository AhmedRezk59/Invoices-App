                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3" id="start_at">
                            ...
                            <div class="input-group">
                                ...
                                </div><input class="form-control fc-datepicker" name="start_at" placeholder="YYYY-MM-DD"
                                    type="text">
                            </div><!-- input-group -->
                        </div>
                        ...
                        <div class="col-lg-3" id="end_at">
                            ...
                            <div class="input-group">
                                ...
                                </div><input class="form-control fc-datepicker" name="end_at" placeholder="YYYY-MM-DD"
                                    type="text">
                            </div><!-- input-group -->
                        </div>
                    </div><br>
                                ...
                                @foreach ($invoices as $invoice)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            @else
                                                <span class="text-warning">{{ $invoice->status->name }}</span>
                                            @endif
